...
mathOP vars expr = let (func, x, y) = case (eval vars x, eval vars y) of
...
boolOp vars expr = let (ordering, x, y) = case (eval vars x, eval vars y) of
...
logicalOp vars expr = let (func, x, y) = case (eval vars x, eval vars y) of
